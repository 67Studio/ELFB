...
print("📍 STEP 7: Loading Fun Tab content...")
...
print("✅ STEP 7: Fun Tab content loaded!")
print("📍 STEP 8: Creating Halloween Tab...")
...
print("✅ STEP 8: Halloween Tab created!")
...
print("✅ STEP 8: Halloween Tab content loaded!")
print("📍 STEP 9: Creating Shaders Tab...")

local ShadersTab = Window:MakeTab({ "Shaders", "server" })

print("✅ STEP 9: Shaders Tab created!")
...
print("✅ STEP 10: Troll Tab created!")
})
...
print("✅ STEP 11: Troll Tab completed!")
print("📍 STEP 12: Loading additional tabs (Anime, Protector, etc)...")

-- Wrap remaining tabs in pcall to prevent crashes
pcall(function()
...
AnimeTab:AddButton({
    ...
    Callback = function()
-- Serviços
print("✅ STEP 11: Anime Tab created!")
...
print("✅ STEP 12: Avatar Tab created!")
...
end) -- END OF ADDITIONAL TABS PCALL

print("\n" .. string.rep("=", 70))
print("✅✅✅ IRVIN HUB COMPLETE VERSION LOADED! ✅✅✅")
print("Core tabs loaded successfully!")
print("Some additional features may not be available.")
print(string.rep("=", 70) .. "\n")
